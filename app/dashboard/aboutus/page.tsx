      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {aboutData ? "View and manage your about page content" : "No about page data found"}
            </p>
          </div>
        ...
        {!aboutData && !loading && (
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No About Page Data</h3>
            <p className="text-gray-500 mb-6">Create your first about page content to get started.</p>
            <button
              onClick={() => {
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center p-6">
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
                    {aboutData.heroTitle || "Welcome to Our Company"}
                  </h1>
                  <p className="text-lg text-white max-w-2xl">
                    {aboutData.heroDescription || "We are dedicated to providing the best service"}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {aboutData.mission || "No mission statement provided"}
                  </p>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-lg font-semibold text-green-800">Our Vision</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed">
                    {aboutData.vision || "No vision statement provided"}
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {aboutData.stats.map((stat, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg text-center border border-gray-100 hover:shadow-md transition">
              ...
              {(aboutData.createdAt || aboutData.updatedAt) && (
                <div className="border-t pt-4 mt-4">
                  <p className="text-xs text-gray-400 flex items-center gap-1">
                    ...
                    Last updated: {aboutData.updatedAt ? new Date(aboutData.updatedAt).toLocaleString() : 'N/A'}
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleUpdate} className="p-6 space-y-6">
                {/* Hero Section */}
                <div className="space-y-4">
                  <h3 className="font-semibold text-gray-700 border-b pb-2">Hero Section</h3>
